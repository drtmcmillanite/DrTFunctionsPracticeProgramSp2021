...
int main()
{
    ...
    /*Programming Challenges
      ...
      **6. Extend this program set the precision of the numberCube result to 4 decimal places
      7. Loop the program until exit conditions 'E' AND 'e', clear the screen upon each loop #include<cstdlib> system("clear"); system("cls"); 
      ***8. Add input validation with Dr_T's .h file 
      9. Add add a class to this program - we will discuss next live session. 
    */
    return 0;
}
